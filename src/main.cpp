...
TestForKonaVector2D() {
    ...
    v2d1 = Vector2D(Point(0, 0), Point(1, 0));
    v2d1 = v2d1.getStrechedVector(1);
    ASSERT(v2d1.getStartPosition().x    == -1 && v2d1.getStartPosition().y    == 0);
    ASSERT(v2d1.getTerminalPosition().x == 2  && v2d1.getTerminalPosition().y == 0);
}
